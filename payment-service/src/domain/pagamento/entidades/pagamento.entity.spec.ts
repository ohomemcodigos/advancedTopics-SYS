...
describe('Pagamento', () => {
    ...
    const metodo = new MetodoPagamento('Pix', 'Chave Aleatoria') as MetodoPagamento;
    const valorTransacao = new Dinheiro(199.90, 'BRL') as Dinheiro;

    const pagamento = new Pagamento('PAG-001', 'PED-001', metodo, valorTransacao) as Pagamento;
...
it('deve registrar o metodo de pagamento e o valor', () => {
    const metodo = new MetodoPagamento('Cartão de Crédito', 'Token123') as MetodoPagamento;
    const valorTransacao = new Dinheiro(250.00, 'USD') as Dinheiro;
