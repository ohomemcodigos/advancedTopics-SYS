...
describe('Usuario', () => {
    it('deve instanciar um usuario com UUID e atributos de perfil', () => {
        const credenciais: Credenciais = new Credenciais('usuario@email.com', 'senhaHash123');
        const regiao: Regiao = new Regiao('Brasil');
        const perfil: Perfil = new Perfil('João', 'joao_dev', 'url_avatar.png');

        const usuario: Usuario = new Usuario('123e4567-e89b-12d3-a456-426614174000', credenciais, regiao, perfil);
